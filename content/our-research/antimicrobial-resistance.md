...
<p>Some of this work has been supported by grants from the National Institute for Health and Care Research (NIHR) and other external sources. We continue to develop some of our more promising antimicrobials (antiseptics, disinfectants and antibiotics) through working with a variety of partners across government and in universities. We are in discussion with external funders about using some of the models developed on the project to directly support further antimicrobial discovery and evaluation projects.</p>

{{< /spotlight-feature >}}

{{< spotlight-content title="Antimicrobal Resistance and the Burden on Public Health" image="amrbacteriophage.jpg" alt="Antimicrobal resistance" caption="Bacteriophage" >}}
...
{{< spotlight-content image="amr2.jpg" alt="Antimicrobal resistance" caption="E.Coli" >}}
