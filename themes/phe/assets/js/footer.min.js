...
"use strict";!function(n){var s=n(".js-tabs-dropdown"),o=n(".nav-tabs--research"),i=o.find(".nav-link");function t(){o.removeClass("is-open")}s.on("click",(function(){o.hasClass("is-open")?t():o.addClass("is-open")})),i.on("click",(function(){var o=n(this).text();s.text(o),console.log(o),t()}))}(jQuery);
